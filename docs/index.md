...
This directory is the repo record. Start with [../AGENTS.md](../AGENTS.md), then [runbooks/index.md](runbooks/index.md).
...
- [runbooks/csp.md](runbooks/csp.md)
...
- [conditional_rollout_solver_memory_analysis.md](conditional_rollout_solver_memory_analysis.md)
- [csp_conditional_bridge.md](csp_conditional_bridge.md)
...
- [experiments/current_training_matrix.md](experiments/current_training_matrix.md)
- [experiments/transformer_pair_geometry.md](experiments/transformer_pair_geometry.md)
...
- [runbooks/repo-health.md](runbooks/repo-health.md)
- [runbooks/skills.md](runbooks/skills.md)
- [harnessengineering.md](harnessengineering.md)
- [harnessengineering_reference.md](harnessengineering_reference.md)
- [../Makefile](../Makefile)
- [../scripts/repo_health.py](../scripts/repo_health.py)
- [../scripts/refactor_hotspots.py](../scripts/refactor_hotspots.py)
