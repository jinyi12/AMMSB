...
run_step "Calibrate sigma from patch-8 token-native latents" \
  ...
  bash "${SCRIPT_DIR}/calibrate_sigma_transformer_patch8_adamw_beta1e3_l128x128.sh"
...
run_step "Train patch-8 token-native CSP DiT bridge" \
  ...
  bash "${SCRIPT_DIR}/train_csp_token_dit_transformer_patch8_adamw_beta1e3_l128x128.sh" --foreground
...
run_step "Evaluate patch-8 token-native CSP DiT bridge" \
  ...
  bash "${SCRIPT_DIR}/evaluate_csp_token_dit_transformer_patch8_adamw_beta1e3_l128x128.sh" --foreground
