...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build a token-native transformer FAE latent archive and train the token-native CSP DiT bridge."
        ),
    )
    ...
    parser.add_argument(
        ...
        help="Output run directory for token-native CSP artifacts.",
    )
    parser.add_argument(
        "--latents_path",
        type=str,
...
def main() -> None:
    ...
    print("============================================================", flush=True)
    print("Token-native CSP training from FAE assets", flush=True)
