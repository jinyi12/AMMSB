...
# ===================================================================
# Denoiser D2 — Extended training (150K steps)
# ===================================================================
# Same config as D1 but 3x longer training to determine whether the
# denoiser's underperformance vs deterministic FiLM is due to
# insufficient training or a fundamental architecture limitation.
#
# Loss analysis at 50K: slope = -3.15e-4/eval (flattening but not flat).
# Per-5K improvement: 30K→50K = 4.4%. Extrapolated plateau ~0.17.
# ===================================================================
