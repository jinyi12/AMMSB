...
# ===================================================================
# Denoiser D1 — Heek et al. protocol (Muon, 50K steps)
# ===================================================================
# Iterative denoiser decoder with latent diffusion prior, following
# Heek et al. 2026 UL §3.1-3.2.
#
# Results: A run exists at
...
nohup "$PYTHON_BIN" scripts/fae/fae_naive/train_attention_denoiser.py \
  ...
  --eval-interval 25 \
  --eval-n-batches 5 \
  --vis-interval 5 > fae_denoiser_heek.log 2>&1 &
