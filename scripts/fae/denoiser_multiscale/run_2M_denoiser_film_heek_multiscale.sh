...
# ===================================================================
# Experiment 2M — Denoising FiLM decoder, Heek protocol, Multiscale
# ===================================================================
# Multiscale version of Experiment 2 (Heek et al. 2026 protocol).
#
...
#   Exp 2M (this)  FiLM diffusion, prior, sigmoid-weighted velocity, multiscale
...
# Tests whether iterative denoising benefits hold at realistic multiscale.
#
# Isolates: Iterative denoising benefit over deterministic FiLM + prior,
# with realistic multiscale features (8× gradient imbalance).
#
# Key protocol details (unchanged from single-scale):
...
nohup "$PYTHON_BIN" scripts/fae/fae_naive/train_attention_denoiser.py \
  ...
  --output-dir results/fae_denoiser_film_heek_multiscale \
  ...
  --eval-interval 25 \
  --eval-n-batches 5 \
  --vis-interval 5 > fae_denoiser_film_heek_multiscale.log 2>&1 &
