...
def _sample_conditional_trajectory_dense_impl(
    drift_net: ConditionalDriftNet,
    initial_state: jax.Array,
    global_condition: jax.Array,
    generation_zt: jax.Array,
...
def sample_conditional_dense_batch_from_keys(
    drift_net: ConditionalDriftNet,
    z_batch: jax.Array,
    zt: jax.Array,
    sigma_fn: SigmaFn,
    ...
    *,
    ...
    """Sample dense conditional trajectories using explicit per-trajectory PRNG keys."""
    z_batch_arr = jnp.asarray(z_batch)
    ...
    return jax.vmap(
        lambda z, global_cond, subkey: _sample_conditional_trajectory_dense_impl(
            drift_net,
            z,
            global_cond,
            generation_zt,
