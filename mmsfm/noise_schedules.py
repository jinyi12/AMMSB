"""Noise schedules used by latent flow matching.

These utilities used to live in `scripts/noise_schedules.py`, but are part of the
library surface (imported by `mmsfm.latent_flow.*`).
"""
